    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            Princesa_DisneyTheme {
                Surface( //ocupa todo o espaço do celular por padrao
...
@OptIn(ExperimentalMaterial3Api::class) //biblioteca de icons
@Composable
fun TelaLogin(aoClickEnterNavigation: () -> Unit) {
    Column(modifier = Modifier.fillMaxSize() .padding(12.dp),
        ...
        TextField(
            value = password,
            onValueChange = {
                password = it //todo valor que for atribuido dento de uma lambda
                //e reconhecido como it,
            },
            Modifier
                .padding(8.dp)
                .fillMaxWidth(),
        ...
        ) //coloca uma mascara de senha no app
        Button(
